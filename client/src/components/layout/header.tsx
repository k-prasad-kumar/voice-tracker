import { GalleryHorizontalEndIcon, PlusIcon } from "lucide-react";
import { Button } from "../ui/button";
import { Link } from "react-router-dom";

const Header = () => {
  return (
    <header className="w-full h-16 border px-2 sm:px-5 md:px-14 shadow-sm flex items-center">
        ...
        <div className="flex gap-2">
          <Link to="/tasks" className="cursor-pointer">
            <Button className="cursor-pointer font-bold">
              ...
              />{" "}
              <span className="hidden md:flex">My Tasks</span>
            </Button>
          </Link>
